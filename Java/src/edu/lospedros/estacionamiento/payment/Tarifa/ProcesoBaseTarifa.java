...
import edu.lospedros.estacionamiento.data.Vehiculo;
import edu.lospedros.estacionamiento.data.Vehiculosize;
...
public class ProcesoBaseTarifa implements TarifaProceso {

    private final Map<Vehiculosize, BigDecimal> TarifaHoraria;
    private final Map<Vehiculosize, BigDecimal> CargoMinimo;

    public ProcesoBaseTarifa(Map<Vehiculosize, BigDecimal> hourlyRates,
    ...
    public static ProcesoBaseTarifa ConTarifasBase() {
        ...
        return new ProcesoBaseTarifa(hourly, min);
    }
